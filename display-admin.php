                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    if(isset($_GET['did']))
                                    {
                                        ...
                                        $deleteq = mysqli_query($connection, "delete from tbl_admin where admin_id='{$did}'") or die(mysql_error($connection));
                                    ...
                                    while ($adminrow = mysqli_fetch_array($selectq))
                                    {
                                       ...
                                       echo"<td><a href=''><img src='myimages/edit-icon.png'> Edit</a> |<a href='display-admin.php?did={$adminrow['admin_id']}'><img src='myimages/delete-icon.png'>  Delete</a> </td>";
                                       echo"</tr>";
                                    }
                                    ?>
