                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    if(isset($_GET['did']))
                                    {
                                        ...
                                        $deleteq = mysqli_query($connection, "delete from tbl_area where area_id='{$did}'") or die(mysql_error($connection));
                                    ...
                                    while ($userrow = mysqli_fetch_array($selectq))
                                    {
                                       ...
                                       echo"<td><a href=''><img src='myimages/edit-icon.png'> Edit</a> |<a href='display-area.php?did={$userrow['area_id']}'><img src='myimages/delete-icon.png'>  Delete</a> </td>";
                                       echo"</tr>";
                                    }
                                    ?>
