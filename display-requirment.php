    ...
    <body class="cbp-spmenu-push">
        <div class="main-content">
            ...
            <div id="page-wrapper">
                <div class="main-page">
                    <div class="tables">
                        <h2 class="title1"> Requirment Table </h2>
                        <div class="panel-body widget-shadow">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $selectq = mysqli_query($connection, "select * from tbl_requirment") or die(mysqli_error($connection));
                                    ...
                                    while ($userrow = mysqli_fetch_array($selectq)) {
                                        ...
                                        echo"<td><a href=''><img src='myimages/edit-icon.png'> Edit</a> |<a href='display-requirment.php?did={$userrow['requirment_id']}'><img src='myimages/delete-icon.png'>  Delete</a> </td>";
                                        echo"</tr>";
                                    }
                                    ?>
